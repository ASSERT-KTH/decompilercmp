...
PROJECTS="dctest Bukkit commons-collections commons-lang DiskLruCache joda-time junit4 scribejava commons-codec commons-imaging javapoet jsoup mimecraft spark"
...
DECOMPILERS="Arlecchino Procyon-0.5.34"
